...
Terminology:
- **a11y tree:** Accessibility tree snapshot generated by browser observation tools.
- **CSS selector:** A rule for targeting specific page elements (for example, `.reference`).
