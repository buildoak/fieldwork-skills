...
### Initial release
All files are new. Copy the entire `web-search/` directory.

| Category | Files |
|----------|-------|
| Core | `SKILL.md` |
| References | `references/tool-comparison.md`, `references/error-patterns.md` |
| Scripts | `scripts/search-check.sh`, `scripts/setup.sh` |
